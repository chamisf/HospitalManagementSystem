...
export class PatientService {
    ...
    private convertItemFromServer(json: any): Patient {
        ...
        entity.registeredDate = this.dateUtils
            .convertLocalDateFromServer(json.registeredDate);
    ...
    private convert(patient: Patient): Patient {
        ...
        copy.registeredDate = this.dateUtils
            .convertLocalDateToServer(patient.registeredDate);
