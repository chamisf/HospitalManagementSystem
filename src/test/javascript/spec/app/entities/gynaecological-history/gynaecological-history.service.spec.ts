...
describe('Service Tests', () => {
    ...
    describe('GynaecologicalHistory Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GynaecologicalHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/gynaecological-histories/' + 123);
            });
            it('should return GynaecologicalHistory', () => {

                let entity: GynaecologicalHistory;
                service.find(123).subscribe((_entity: GynaecologicalHistory) => {
                    entity = _entity;
                });
