...
describe('Service Tests', () => {
    ...
    describe('PersonalSocialDetails Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PersonalSocialDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/personal-social-details/' + 123);
            });
            it('should return PersonalSocialDetails', () => {

                let entity: PersonalSocialDetails;
                service.find(123).subscribe((_entity: PersonalSocialDetails) => {
                    entity = _entity;
                });
