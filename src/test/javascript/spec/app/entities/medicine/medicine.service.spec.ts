...
describe('Service Tests', () => {
    ...
    describe('Medicine Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MedicineService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/medicines/' + 123);
            });
            it('should return Medicine', () => {

                let entity: Medicine;
                service.find(123).subscribe((_entity: Medicine) => {
                    entity = _entity;
                });
