...
describe('Service Tests', () => {
    ...
    describe('Allergy Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AllergyService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/allergies/' + 123);
            });
            it('should return Allergy', () => {

                let entity: Allergy;
                service.find(123).subscribe((_entity: Allergy) => {
                    entity = _entity;
                });
